    ...
    $(':button').click(function(){
            ...
            ************************************************************************************************/
            ...
            $.ajax({
                ...
                url:'https://api.themoviedb.org/3/search/movie?api_key=3a8f06f6e5bb950d56bb89d0bf1a4705',
                data: query
            })
            ...
            .done(function(json){
                 ...
                 *********************************Insert Code Below********************************************/               
                $("#release-date").html(json.results[0].release_date);
                ...
                $("#original-language").html(json.results[0].original_language);
